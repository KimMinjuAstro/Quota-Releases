...
<p align="center">
  <img src="assets/screenshot-light.png" alt="Quota 화면" width="85%">
</p>
...
- `＋` 버튼으로 서비스별 계정을 최대 3개까지 추가할 수 있습니다.
- 카드를 드래그해 순서를 바꾸고, 가장자리 화살표로 열·행을 조절합니다.
- 설정에서 테마, 크기, 투명도, 자동 실행 및 초기화 알림을 변경합니다.

## 데이터 및 삭제

로그인 정보는 개발자에게 전송되지 않으며, 앱 설정은 `%APPDATA%\Quota`에 저장됩니다. 앱은 **Windows 설정 → 앱 → Quota**에서 제거할 수 있습니다.
